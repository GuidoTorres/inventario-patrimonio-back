...
const postDependencias = async (req, res) => {
    try {
        ...
        res
            .status(500)
            .json({ message: "No se pudo crear la dependencia.", error: error.message });
    }
};
...
const updateDependencias = async (req, res) => {
    try {
        ...
        res
            .status(500)
            .json({ message: "No se pudo actualizar la dependencia.", error: error.message });
    }
};
...
const deleteDependencias = async (req, res) => {
    try {
        ...
        res
            .status(500)
            .json({ message: "No se pudo eliminar la dependencia.", error: error.message });
    }
};
...
module.exports = { getDependencias, postDependencias, updateDependencias, deleteDependencias }